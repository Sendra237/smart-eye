...
export default function SignUpPage() {
  ...
  return (
<>
{popup && <PopupManager setPopup={setPopup} />}
      ...
      <div className="left-section">
        <div className="login-box">
          ...
          <form className="login-form">
            ...
            <input type="Phone" placeholder="Email" className="input" />
           ...
           <input value={"Continuer"} className="btn-continue" onClick={() => setPopup(true)}/>
